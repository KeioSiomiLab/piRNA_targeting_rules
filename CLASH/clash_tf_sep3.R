# clash_tf_sep2
# /usr/bin/Rscript --silent --slave --vanilla clash_tf_sep2.R Process3/{/.}_tf_map.sam Process3/{/.}_comp_tf.tsv piRNA/anno/piRNA_all2.tsv Process3/{/.}_chimera

#######################################################################################################
# separate chimera file into piRNA and target sequence
#######################################################################################################

# hybdir <- "/media/pericles/CLASH/Process3/rep1_tf_map.sam"
# CLASHdir <- "/media/pericles/CLASH/Process3/rep1_comp_tf.tsv"
# piRNAdir <- "/media/pericles/CLASH/piRNA/anno/piRNA_all2.tsv"
# outname <- "/media/pericles/CLASH/Process3/rep1_chimera"
