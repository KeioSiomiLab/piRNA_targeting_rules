...
library(tidyverse)
# hybdir <- "/media/hermione/SMEDWI3/Process3/SRR8842976_tf_map.sam"
# CLASHdir <- "/media/hermione/SMEDWI3/Process3/SRR8842976_comp_tf.tsv"
# piRNAdir <- "/media/hermione/SMEDWI3/database/piRNA_all.tsv"
# outname <- "/media/hermione/SMEDWI3/Process3/SRR8842976_chimera"
...
#  filter(targetlen > pilen) %>%
  select(readname,piRNA,pilen,piRNAseq,target2,bedstart,bedend,targetlen,targetseq,cigar)
