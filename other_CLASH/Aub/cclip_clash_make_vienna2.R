...
# hybdir <- "/media/hermione/cCLIP/Process3/SRR3051373_chimera.tsv"
# rnaplexname <- "/media/hermione/cCLIP/vienna/SRR3051373.rnaplex"
# outname <- "/media/hermione/cCLIP/vienna/SRR3051373"
...
rnaplex3 <- hybtest %>%
  separate(piRNA, sep = "_", into = c("piRNA","dis2","piRNAtype")) %>%
  left_join(rnaplex2,by = c("piRNA","readname")) %>%
  ...
  separate(target2, sep = "_", into = c("target","targetname","targettype")) %>%
