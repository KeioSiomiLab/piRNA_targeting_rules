...
#hybdir <- "/media/hermione/cCLIP/Process2/SRR3051373_map.sam"
#CLASHdir <- "/media/hermione/cCLIP/Process2/SRR3051373_comp.tsv"
#piRNAdir <- "/media/hermione/cCLIP/piRNA_all.tsv"
#outdir <- "/media/hermione/cCLIP/Process2/SRR3051373_comp_tf.fasta"
