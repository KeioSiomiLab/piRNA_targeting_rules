#######################################################################################################
# filtering genome mapped sequence
#######################################################################################################
# /usr/bin/Rscript  filter_endtoend.R endtoend/${X}_map2.sam Process/${X}_del.tsv Process/${X}_comp2.fasta;
.libPaths("~/R/x86_64-pc-linux-gnu-library/4.2/")
library(tidyverse)

# samdir <- "/media/hermione/PRG1_CLASH/endtoend/SRR6512652_map2.sam"
# readdir <- "/media/hermione/PRG1_CLASH/Process/SRR6512652_del.tsv"
# outdir <- "/media/hermione/PRG1_CLASH/Process/SRR6512652_comp2.fasta"
